...
``` r
mel_aty.fit$results[c(1,2,3,6,7,9)] %>%
...
```
    ...
    ## 2 MEL ~~ MDD         0.99           0.039 2.5e-141
    ## 3 ATY ~~ MDD         0.69           0.129  9.4e-08
...
list("A"=list(name="Common", model=commonfactor.fit),
     ...
     "L"=list(name="Depression-Melancholic-Atypical", model=mel_aty.fit)
     )
