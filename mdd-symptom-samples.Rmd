...
names(basic_xls_list) <- str_match(basename(basic_xls_list), "basic\\.([A-Z_]+)\\.(MDD[A-Za-z0-9_]+)\\.num\\.xls")[,2]
...
inner_join(filter(basics, meta %in% c('AGDS_PGC', 'ALSPAC_UKB')), by='Dataset') 
