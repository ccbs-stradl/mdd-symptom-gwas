...
curl 'https://public.boxcloud.com/d/1/b1!Ig4kcOi79AyLq_ZRX8FjHkvt6Po00Y6YqwN8wuER4__laOMPSMuMho40OgLDhkTGJrIrekFdhPPbhkPvp6F_cGglssbvvhvDSYWJOk33p5BVrrjt9lLjSQe7Z7KHPF8pmBdaxaa6yP_ooYshyWYdss7veC9RO9cGabPWIGbqlfzEJOhGI3tPQHX-ri_5NiHEJF-eq-OFEfkhY3GUgXQGI90TdK4280tHSH_Nu1aD0vZiOre_V1wJxg57YSGujsJNhhT5mPeBYw9F8xRDXn-NfgX2RslTW51Li8DDTXk1kAEP3_i0ccVVBPCO78YWGUPYE94xJXM0lSARJ76VmMekZG0c2MuDiTyO2PF16uB_NdHZ--a0668Q_C8_szHLMakUZTOqXKDZixjInGP_XrQOJgqY-75ZJUu5pU1qA4Y1ye9moKmABldnzYpGXf4YPp3oBZAG1JhULpjpfeZc4ubKjsBgTG9fE-WI4OAm4FMr9FBIsYwGIgFb87TxrsK2xICFGEowk9cqWL7XoWNAF-15aslI4yfZHDevpPYoE-RxwoaWPEG56H9Dkeb4o9SRZ5rHtcfVaVv3Y7n1upfdl04uZFqfeZDmfS1v4S9DBLvrmlRsDOGO_9qNW0j5pE07hmxjVv_o-IA5B8cCJ84QpMtPpDvat1Prz031MsEbmaTg7Bf0h-83G1I4b8sjmkwB1NtM460dzaph0FMzu1TCXvx0ij1lYh1X1EvwfpFrMgzwph0n_0aTqjf54wf0BwnyEwJJqXqI-WS8Mi14dzK3Akm2j5Jq3MU4X2nXNCvqSSmJbzqLGZC9F8NueqtY8rnal7JtLsZgWm1kq1Zl8FDcH_7j9RDEZiLZwn90EDYo_6J0HusqkkobkFtUqCyavduI-ClKlsMCIlW53ubrWSkdTtnhNbheHKplqxpwLcYPrRqeHPjbnX-QFUNpe1sbe1HjPHq3w89SUNY9hyOT1D-Ls8AjZ2UVwBNnbaoCVwguiuu79Skr521Ve4yCrSpYd6OSpixmt7Od2UXRCbqCkHAIkC7QaBDjJQAXoeoLGmce7QHVraBabDkDUpfGvsHKeDP5Q_7sEg4aboGmQVPtHOSimo2QxGBO4qD_JWsIg2iqx-fjH39SayXbMTE1AsY-rFQvCe5Jl-yYbA1e2YuBKG07BhmluJP9VL7SOXG1q23v68melX1gCAQNZTSMoLVpO-r5FJwpW7wDPg-RmvBJwglLjhN4axO2qK_qdT4BybGRADsULrbWjM-F8Ic6-TmkDxhg-g../download' > sumstats/reference/w_hm3.noMHC.snplist
...
Meta-analysis was conducted using the Ricopoli [daner](https://docs.google.com/document/d/1TWIhr8-qpCXB13WCXcU1_HDio8lC_MeWoAg2jlggrtU/edit) so the summary statistics are in the  ("**D**osage **An**alyz**er**) format. These can be munged with `munge_sumstats.py` from the [ldsc](https://github.com/bulik/ldsc) program. We find all daner files in the PGC directory and loop them through the munge step.
...
for sumstats in $(find meta/distribution -regex ".*/daner[A-Za-z_]*\.MDD[1-9a-z]*_[A-Za-z]*\.gz"); do
  prefix=$(basename $sumstats .gz)
  if [ ! -f meta/ldsc/${prefix}.sumstats.gz ]; then
    munge_sumstats.py --daner-n \
    --sumstats $sumstats \
    --merge-alleles sumstats/reference/w_hm3.noMHC.snplist \
    --chunksize 50000 \
    --out meta/ldsc/${prefix}
  fi
done
