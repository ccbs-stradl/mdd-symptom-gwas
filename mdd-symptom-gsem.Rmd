...
pgc_commonfactor.gv <- generate_dot(fit_graph(pgc_commonfactor.fit$results))

# add in block to specify node ranks
pgc_commonfactor.gv.list <- str_split(pgc_commonfactor.gv, '\n\n')[[1]]

# move the nodes/edges element to the end
pgc_commonfactor.gv.list[6] <- pgc_commonfactor.gv.list[5]

# add manually made ranks
pgc_commonfactor.gv.list[5] <- "{rank=same '1'}\n{rank=same '2' '3' '4' '5'}" 

pgc_commonfactor_rank.gv <- paste(pgc_commonfactor.gv.list, collapse='\n\n')

grViz(pgc_commonfactor_rank.gv)
