...
ggplot(sumstats_h2_labels %>% mutate(Neff=4*Nca*Nco/(Nca+Nco)) %>% filter(Neff >= 5000), aes(x=abbv, y=h2, ymin=h2+se*qnorm(0.025), ymax=h2+se*qnorm(0.975))) +
geom_hline(yintercept=0, col='grey') +
geom_pointrange() + 
facet_grid(cols=vars(cohorts)) +
...
mdd_symptom_gsem_h2.gg + coord_flip(ylim=c(0, 0.175))

ggsave('mdd-symptom-gsem_files/symptoms_h2_snp.png', width=10, height=6)

```

```{r mdd_symptom_gsem_h2_full}
...
ggsave('mdd-symptom-gsem_files/symptoms_h2_snp_full.png', width=12, height=6)
