...
"
pop_ext.fit <- usermodel(symptoms_covstruct, estimation='DWLS', model=pop_ext.model)

pop_ext.fit$modelfit
pop_ext.fit$results %>%
select(lhs, op, rhs, STD_Genotype, STD_Genotype_SE, p_value) %>%
filter(rhs %in% ext_trait_names, lhs %in% c('ClinSoma', 'ClinSui', 'Affect', 'Neuroveg'))

```

```{r clin_ext, cache=TRUE}
...
clin_ext.fit <- usermodel(symptoms_covstruct, estimation='DWLS', model=clin_ext.model)

clin_ext.fit$modelfit
clin_ext.fit$results %>%
select(lhs, op, rhs, STD_Genotype, STD_Genotype_SE, p_value) %>%
...
clin_ext_mult.fit$modelfit
clin_ext_mult.fit$results %>%
select(lhs, op, rhs, STD_Genotype, STD_Genotype_SE, p_value) %>%
filter(lhs %in% ext_trait_names, rhs %in% c('ClinSoma', 'ClinSui', 'Affect', 'Neuroveg'))
...
pop_ext_mult.fit$modelfit
pop_ext_mult.fit$results %>%
select(lhs, op, rhs, STD_Genotype, STD_Genotype_SE, p_value) %>%
filter(lhs %in% ext_trait_names, rhs %in% c('ClinSoma', 'ClinSui', 'Affect', 'Neuroveg'))
