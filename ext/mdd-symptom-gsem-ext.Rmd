...
ggplot(mutate(ext_fdr, FDR = if_else(fdr <= 0.05, true = 'Sig.', false = 'Non-Sig.')),
       aes(x=factor(Factor,
	   			 levels=c('GATE','DEP', 'APP'),
					 labels=c("Gating", "Cog/Mood/Leth", "Appetite/Weight")),
           y=STD_Genotype,
           color=interaction(Beta, FDR, sep = '-'),
           shape=interaction(Beta, FDR),
...
scale_color_manual('Regression:',
                    values = c('Single-Sig.' = '#f8766d',
                               'Single-Non-Sig.' = '#f8766d',
                               'Multiple-Sig.' = '#609dff',
                               'Multiple-Non-Sig.' = '#609dff')) +
scale_shape_manual('FDR:', values = c('Single.Sig.' = 16, 'Single.Non-Sig.' = 21, 'Multiple.Sig.' = 15, 'Multiple.Non-Sig.' = 22)) +
