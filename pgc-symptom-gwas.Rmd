...
Symptom presence/absence among cases
...
#Run analysis
postimp_navi --out MDD1_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD1_PGCMDD2_final.txt #Done
postimp_navi --out MDD2_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD2_PGCMDD2_final.txt #Done
postimp_navi --out MDD3a_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD3a_PGCMDD2_final.txt #Done
postimp_navi --out MDD3b_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD3b_PGCMDD2_final.txt
postimp_navi --out MDD4a_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD4a_PGCMDD2_final.txt
postimp_navi --out MDD4b_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD4b_PGCMDD2_final.txt
postimp_navi --out MDD5a_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD5a_PGCMDD2_final.txt
postimp_navi --out MDD5b_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD5b_PGCMDD2_final.txt
postimp_navi --out MDD6_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD6_PGCMDD2_final.txt
postimp_navi --out MDD7_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD7_PGCMDD2_final.txt
postimp_navi --out MDD8_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD8_PGCMDD2_final.txt
postimp_navi --out MDD9_CasesAllCohorts.1909 --mds MDD29.0515.nproj.menv.mds_cov --coco 1,2,3,4,5,6 --popname eur --pheno MDD9_PGCMDD2_final.txt

```

## Cohorts without symptom data

MDD case/control GWAS on all other cohorts. Replace `PATH` with path to single dataset summary statistics.
...
ln -s /home/PATH/single_dataset/* .
ln -s /home/PATH/single_dataset/additional_datasets/ * .
ln -s /home/PATH/daner_23andMe_v5_170227_pgc_aligned_.assoc.gz
ln -s /home/PATH/v1/reference_info 

```

### PGC anchor cohorts

Run the [post-imputation module on just summary statistics](https://docs.google.com/document/d/1o4bN_uLK4IEItXCSdeQkXfZwEpLuSCWlveJevRogi08/). First, PGC anchor cohorts that were not included in the GWAS of symptoms

```{bash, eval=FALSE}

cat > pgc_mdd0_datasets << EOF
daner_mdd_edi2_eur_sr-qc.hg19.ch.fl.gz
daner_mdd_i2b3_eur_sr-qc.hg19.ch.fl.gz
daner_mdd_jjp2_eur_sr-qc2.hg19.ch.fl.gz
daner_mdd_pfm2_eur_sr-qc2.hg19.ch.fl.gz
daner_mdd_roc3_eur_sr-qc.hg19.ch.fl.gz
EOF

postimp_navi --result pgc_mdd0_datasets --out pgc_mdd0.1019
...
ln -s report_pgc_mdd0.1019/daner_pgc_mdd0.1019.gz .

cat > mdd0_datasets << EOF
daner_pgc_mdd0.1019.gz
daner_GERA.euro.depress.0915a_mds5.id.gz
daner_mdd_decode_160211.gz
daner_mdd_genscot_1215a.gz
daner_mddGWAS_new_ipsych_170220.meta.gz
daner_23andMe_v5_170227_pgc_aligned_.assoc.gz
EOF

postimp_navi --result mdd0_datasets --out pgc_mdd0_meta.1019

cat > mdd0_datasets_noiPsych << EOF
daner_pgc_mdd0.1019.gz
daner_GERA.euro.depress.0915a_mds5.id.gz
daner_mdd_decode_160211.gz
daner_mdd_genscot_1215a.gz
...
postimp_navi --result mdd0_datasets_noiPsych --out pgc_mdd0_meta_noiPsych.1019

cat > mdd0_datasets_noiPsych_no23andMe << EOF
daner_pgc_mdd0.1019.gz
daner_GERA.euro.depress.0915a_mds5.id.gz
daner_mdd_decode_160211.gz
daner_mdd_genscot_1215a.gz
...
postimp_navi --result mdd0_datasets_noiPsych_no23andMe --out pgc_mdd0_meta_noiPsych_no23andMe.1019

cat > mdd0_datasets_no23andMe << EOF
daner_pgc_mdd0.1019.gz
daner_GERA.euro.depress.0915a_mds5.id.gz
daner_mdd_decode_160211.gz
daner_mdd_genscot_1215a.gz
...
postimp_navi --result mdd0_datasets_no23andMe --out pgc_mdd0_meta_no23andMe.1019
