...
while read cohort; do
  ...
  elif [ -f ${V1}_boma/cobg_dir_genome_wide_boma/mdd_${cohort}_eur_sr-qc*.hg19.ch.fl.bgn.bed ]; then
  	ln -sf ${V1}_boma/cobg_dir_genome_wide_boma/mdd_${cohort}_*.bgn.{bed,bim,fam} pgc_gwas/cobg_dir_genome_wide/
  elif [ -f  ${V1}_shp/cobg_dir_genome_sho/mdd_${cohort}_eur_sr-qc*.hg19.ch.fl.bgn.bed ]; then
  	ln -sf ${V1}_shp/cobg_dir_genome_sho/mdd_${cohort}_*.bgn.{bed,bim,fam} pgc_gwas/cobg_dir_genome_wide/
  else
...
-work-dir /scratch-shared/$USER/mdd-symptoms-gwas/work \
-resume \
