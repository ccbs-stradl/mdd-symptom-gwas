# Prepare LDSC and sumstats of well-powered clinical symptoms
...
covstruct_prefix <- 'agds_pgc.soma.covstruct'
sumstats_prefix <- 'agds_pgc.soma.sumstats'
...
filter(trait_name %in% c("ClinAppInc", "ClinSleDec", "ClinSleInc", "ClinPsycInc"))
