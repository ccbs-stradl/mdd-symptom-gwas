...
```{r clin_soma_b, cache=TRUE}

clin_soma_b.model <- "
A1 =~ NA*ClinAppInc + ClinSleDec + ClinMotoInc
A2 =~ NA*ClinAppDec + ClinSleInc
A3 =~ ClinSui
A1 ~~ 1*A1
A2 ~~ 1*A2
ClinSui ~~ 0*ClinSui
...
c3b > 0.001
ClinAppInc ~~ c3b*ClinAppInc
c4a > 0.001
ClinSleDec ~~ c4a*ClinSleDec
"

clin_soma_b.fit <- usermodel(symptoms_covstruct, estimation='DWLS', model=clin_soma_b.model)

clin_soma_b.fit$modelfit
clin_soma_b.fit$results[c(1,2,3,6,7, 9)]
