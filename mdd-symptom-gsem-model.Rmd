...
The Atypical/Melancholic model is the best, SRMR is high across all the models, indicating that there are high residual correlations. 

## Modifications

Add residual correlations betwee same-item symptoms across cohorts.

```{r mel_aty_afc_mod, cache=TRUE}
